...
class ArtifactTest(unittest.TestCase):
    ...
    def test_provider_deploy_patches_logical_domains_through_master(self):
        ...
        self.assertIn('expected_digest="$SFL_IMAGE_DIGEST"', function)
        self.assertIn('expected_digest="$PSI_IMAGE_DIGEST"', function)
        self.assertIn('expected_image="$SFL_IMAGE"', function)
        self.assertIn('expected_image="$PSI_IMAGE"', function)
        self.assertIn('expected_image_id="$SFL_IMAGE_ID"', function)
        self.assertIn('expected_image_id="$PSI_IMAGE_ID"', function)
        self.assertIn('"kuscia.secretflow/image-id":"${expected_image_id}"', function)
        self.assertIn('"name":"runner","image":"${expected_image}"', function)
        self.assertIn('"name":"TOPIC4_IMAGE_DIGEST","value":"${expected_digest}"', function)
